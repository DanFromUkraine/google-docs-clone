...
export const Ruler = () => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
        if ((isDraggingLeft || isDraggingRight) && rulerRef.current) {
            const container =
                rulerRef.current.querySelector("#ruler-container");
            if (container) {
                ...
                if (isDraggingLeft) {
                    const maxLeftPosition =
                        container.clientWidth - (rightMargin + 100);
                    ...
                    const maxRightPosition =
                        container.clientWidth - (leftMargin + 100);
                    const newRightPosition = Math.min(
                        maxRightPosition,
                        container.clientWidth - rawPosition,
                    );
    ...
    return (
        <div
            className="h-6 border-b border-gray-300 pl-5 flex items-end relative select-none print:hidden"
            ref={rulerRef}
